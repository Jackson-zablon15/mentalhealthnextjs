    ...
    <section id="about" className="py-16" style={{background: 'var(--soft-white)'}}>
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8 px-4">
        <div className="flex-1">
          ...
          <p className="mb-6" style={{color: 'var(--charcoal-black)'}}>Mental Health Africa is youth led registered non-governmental organization founded in 2024 committed to raising Mental Health , reducing stigma and supporting mentally challenged individuals. While championing the sustainable development goal we believe <i>There is no health without mental health</i> </p>
