...
const GalleryCard = ({ photo, onClick }) => {
  ...
  return (
    <div 
      className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer group flex flex-col min-h-[320px]"
      onClick={onClick}
      style={{ minWidth: 220 }}
    >
      {/* Image Container */}
      <div className="relative overflow-hidden bg-gray-100 flex items-center justify-center" style={{ minHeight: 170 }}>
        {imageLoading && (
          <div className="w-full h-40 flex items-center justify-center">
            <div className="animate-spin rounded-full h-8 w-8 border-b-2" style={{borderColor: 'var(--deep-red)'}}></div>
          </div>
        )}
        <img 
